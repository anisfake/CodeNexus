...
namespace CodeNexus.Application.Features.LearningPathMentorReviews.Queries.GetMyLearningPathReviews;

public class GetMyLearningPathReviewsQueryHandler
    : IRequestHandler<GetMyLearningPathReviewsQuery, Result<List<AdminMentorReviewDto>>>
{
    private readonly IApplicationDbContext _context;
    private readonly ICurrentUserService _currentUserService;

    public GetMyLearningPathReviewsQueryHandler(
    ...
    public async Task<Result<List<AdminMentorReviewDto>>> Handle(
        GetMyLearningPathReviewsQuery request,
