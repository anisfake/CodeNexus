...
public class UpdateMentorPackageCommandValidator : AbstractValidator<UpdateMentorPackageCommand>
{
    public UpdateMentorPackageCommandValidator()
    {
        RuleFor(x => x.MentorPackageId)
            .NotEmpty().WithErrorCode("ID_REQUIRED");
