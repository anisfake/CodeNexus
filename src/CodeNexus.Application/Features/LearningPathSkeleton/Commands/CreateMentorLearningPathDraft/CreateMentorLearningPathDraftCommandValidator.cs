...
public class CreateMentorLearningPathDraftCommandValidator : AbstractValidator<CreateMentorLearningPathDraftCommand>
{
    public CreateMentorLearningPathDraftCommandValidator()
    {
