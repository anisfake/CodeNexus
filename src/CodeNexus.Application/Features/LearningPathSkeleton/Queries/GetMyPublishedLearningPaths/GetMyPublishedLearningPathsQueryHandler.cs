...
public class GetMyPublishedLearningPathsQueryHandler : IRequestHandler<GetMyPublishedLearningPathsQuery, Result<PaginationDto<LearningPathResponse>>>
{
    ...
    public async Task<Result<PaginationDto<LearningPathResponse>>> Handle(GetMyPublishedLearningPathsQuery request, CancellationToken cancellationToken)
    {
        Guid mentorId;
        try
        {
